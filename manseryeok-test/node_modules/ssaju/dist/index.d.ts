...
export declare function lunarToSolar(year: number, month: number, day: number, isLeapMonth: boolean): {
	year: number;
	month: number;
	day: number;
};
...
export declare function calculateSaju(input: SajuInput): SajuResult;
