...
names2 = ["btn_clean.svg", "btn_status.svg", "btn_talk.svg", "btn_pet.svg"]
extract_buttons("app/android/app/src/main/res/drawable/layout_svg/button2.svg", names2)

names1 = ["btn_feed.svg", "btn_bathe.svg", "btn_play.svg", "btn_medicine.svg"]
extract_buttons("app/android/app/src/main/res/drawable/layout_svg/button1-1.svg", names1)
print("Done extracting completely isolated SVGs.")
